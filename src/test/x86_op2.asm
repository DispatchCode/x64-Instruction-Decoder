...
op2C:   cvttss2si eax, xmm1
times   pad - ($ - $op2C) db 0xCC

op2D:   cvtss2si eax, xmm1
times   pad - ($ - $op2D) db 0xCC

op2E:   ucomisd xmm2, xmm1
...
op50:   movmskpd eax, xmm0
times   pad - ($ - $op50) db 0xCC

op51:   sqrtpd  xmm0, xmm1
